...
<div class="grid grid-rows-1 w-auto">
    ...
    <div class="flex flex-wrap justify-between mt-2 px-4 mb-2">
        ...
        <!-- Bulk Add Button -->
        <button @click="openBulkModal" class="bg-[#f5365c] text-white py-2 px-4 hover:bg-[#f5365c] mt-1 -mr-4 lg:mt-0 flex justify-center items-center">
        ...
        <div class="bg-gray-100 p-6 rounded shadow-lg w-full sm:w-[50%] lg:w-[30%]">
            ...
            <div v-for="(row, index) in bulkRows" :key="index" class="mb-4">
                <div class="mb-2">
                    ...
                    <input v-model="row.name" type="text" class="w-full p-2 border" placeholder="Enter full name" />
                </div>
                <div class="mb-2">
                    <label class="block">Date:</label>
                    <input v-model="row.date" type="date" class="w-full p-2 border" />
                </div>
                <div class="mb-2">
                    <label class="block">Status:</label>
                    <select v-model="row.status" class="w-full p-2 border">
            ...
            <div class="mt-4 flex justify-end">
                <button class="bg-red-500 text-black py-2 px-4 hover:bg-red-600" @click="closeBulkModal">
                    Cancel
                </button>
                <button class="bg-green-500 text-black py-2 px-4 hover:bg-green-600 ml-2" @click="addBulkAttendance">
                    Add Attendance
                </button>
            </div>
        </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg w-full sm:w-[50%] lg:w-[30%] max-w-lg">
            ...
            <div class="space-y-4">
                ...
                <p class="text-gray-600"><strong class="font-medium mr-2">Status:</strong>
                    <span :class="[
                    modalData?.status === 'Present' ? 'bg-green-600 py-1 text-white px-2 rounded-sm' :
